...
replaceExact(
  ...
  '<p>Начните с вопроса по своему автомобилю. Администратор уточнит сроки работ и ближайшие даты.</p>',
);
replaceExact(
  '<p>Сообщите марку и модель автомобиля. Администратор предложит ближайшее удобное время.</p>',
  '<p>Напишите марку и модель. Администратор уточнит сроки работ и ближайшие даты.</p>',
);
replaceExact(
