...
- **Evidence refresh:** `2026-08-15 MSK`, canonical parent checkpoint with Wave45 `400/45/1,494.42 RUB`, unchanged 33-visit exact cohort, Wave46 delivery `74/3` with behavioral `N=2`, Wave48 delivery `22/2` with behavioral `N=1`, five relevant actual queries, 35 non-delivering manual phrases, Mango `0`, production smoke, and the 08:41 owner-QA attribution correction
...
- Traffic-quality observation: all five actual Wave46/48 queries are commercial and offer-relevant, and all five clicks came through autotargeting. The 17+18 manual operator phrases received zero impressions, so there is no manual-targeting comparison cell. Obvious query junk is unlikely for the observed five clicks, while total sample and targeting evidence remain insufficient for a causal or optimization decision.
