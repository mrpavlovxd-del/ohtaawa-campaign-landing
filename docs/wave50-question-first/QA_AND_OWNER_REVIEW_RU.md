...
- Для запуска требуется отдельное решение владельца: принять экспериментальный контракт, выбрать чистую Wave50-когорту, утвердить goal mapping и deployment. После этого review — через `30` сопоставимых чистых кликов или `1 500 ₽`, без смешивания Wave45/Wave49/Wave50.
